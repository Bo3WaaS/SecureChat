...
public class ServerWithClientAuth {
	...
	public static void main(String[] args) {
		try {
			SSLContext context = config.getServerSSLContext(KEY_STORE, pass, TRUST_STORE, pass);
			SSLServerSocketFactory socketFactory = context.getServerSocketFactory();
			SSLServerSocket socket = (SSLServerSocket) socketFactory.createServerSocket(5556);
			...
			while(true){
				...
				System.out.println("Client Certificate: " + session.getPeerCertificates()[0]);
